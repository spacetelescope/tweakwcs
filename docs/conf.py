...
def setup(app):
    try:
        app.add_css_file('css/custom-tweakwcs.css')
    except AttributeError:
        app.add_stylesheet('css/custom-tweakwcs.css')
...
import tweakwcs
release = f"{tweakwcs.__version__:s}"
version = release
...
man_pages = [
    ('index', 'tweakwcs', u'tweakwcs Documentation',
     [author], 1)
]
...
epub_title = u'tweakwcs'
epub_author = author
epub_publisher = u'STScI'
epub_copyright = copyright

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'tweakwcs'
